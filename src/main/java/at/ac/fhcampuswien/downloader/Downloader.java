...
public abstract class Downloader {
    ...
    public abstract int process(List<String> urls) throws NewsAPIExceptionLeo;

    public String saveUrl2File(String urlString) throws NewsAPIExceptionLeo {
        InputStream is = null;
        ...
        try {
            ...
            throw new NewsAPIExceptionLeo("Cannot convert " + urlString + " to URL. Error message: " + e.getMessage());
        } catch (IOException e) {
            throw new NewsAPIExceptionLeo("Either failed to open URL: " + urlString + " or failed to write to Folder. Error message: " + e.getMessage());
        } finally {
            try {
                if(is != null)
                    is.close();
